...
//template fin
contract.methods.participantReception().send({from: user[1], value: web3.utils.toWei(web3.utils.toBN(1), 'ether')}).on('error', function(error) { console.log(error);}).then(function(result){
  console.log('finish user2');
});
