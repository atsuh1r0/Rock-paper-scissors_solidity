...
var hashValue = '50695242913393552962065414201093636445561502109545187277502957880317430736682';

//template fin
contract.methods.generateHashValue(hashValue).send({from: user[0]}).on('error', function(error) { console.log(error);}).then(function(result){
  console.log('finish');
});
